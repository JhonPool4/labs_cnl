...
% ==================
%\input{student_information} % add sutdent information (name and lastname) and store in \primeralumno and \secondalumno
...
\newcommand{\makefrontpage}{%
	...
	\begin{center}
		...
		{\Large \labname}\\[1.5cm] 		
		{\Large \textbf{Profesora:}}\\ \vspace{1em}
		{\Large Ruth~Canahuire} \\[1cm]
		{\Large \textbf{Asistentes de enseñanza:}} \\ \vspace{1em} 
		{\Large Jhon~Charaja y Ricardo~Terreros}\\[1cm]
		{\Large \textbf{Estudiantes:}} \\ \vspace{1em} 
		{\Large \firststudent~y~\secondstudent}\\[1.5cm]
